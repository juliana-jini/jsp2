...
<!-- 
	<session-config>
        <session-timeout>30</session-timeout>	마지막 요청 시간으로부터 30분
    </session-config>
 -->
<h3>session 정보 확인</h3>
<%
	...
	out.print("session 생성 시간 : " + create);			//타임스탬프(1970년 1월 1일 기준 단위는 ms)
	out.print("<br>");
	...
	out.print("session 최근 요청 시간 : " + last);			//타임스탬프(1970년 1월 1일 기준 단위는 ms)
	out.print("<br>");
